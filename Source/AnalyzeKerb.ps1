...
namespace AnalyzeKerbCSharp
{
    public class Program
    {
        public static void Main(string[] args)
        {
                    ...
                    using (record)
                    {
                        if (record.Id == 103)
                        {
                            ...
                            using (StringReader strReader = new StringReader(DescriptionString))
                            {
                                ...
                                {
                                    //extract protocol from ServerName
                                    //if "/" is not in ServerName it doesn't specify any protocol
                                    ...
                                    string SingleAuth = ClientDomain + "," + ClientName + "," + ServerDomain + "," + ServerName + "," + record.TimeCreated + "," + Protocol;
            ...
            tw.WriteLine("ClientDomain,ClientName,ServerDomain,ServerName,DateTime,Protocol");
